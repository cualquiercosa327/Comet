...
This cannot work as a module, as the runtime links and loads Comet right before the Bootstrap scene calls the REL prologue.
It has been moved to the runtime, accordingly.

All relevant headers have been moved here to allow the runtime loader to remain as lightweight as possible.
